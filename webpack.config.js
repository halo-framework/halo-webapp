...
module.exports = {
  ...
  entry: {
    ...
    main_css: [
      ...
      path.join(__dirname, 'assets', 'css', 'swagger-editor.css'),
    ],
  },
  output: {
    path: path.join(__dirname, 'webfront_service', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'webfront_service', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ].concat(debug ? [] : [
